...
from routers import converter, image, video_info, video_convert, video_compress, video_gif, video_edit, board_layout, audio, lyric_video, music
...
app.include_router(lyric_video.router, prefix="/api")
